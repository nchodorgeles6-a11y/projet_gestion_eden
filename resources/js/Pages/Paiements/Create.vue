...
const form = useForm({ user_id: '', montant: '', mois: '', annee: '' });
const submit = () => form.post('/paiements');
...
const annees = ['2024','2025','2026','2027','2028','2029'];
</script>

<template>
    <Head title="Ajouter Paiement" />
    <AuthenticatedLayout>
        <div class="p-4 sm:p-6 max-w-2xl">
            <div class="flex items-center justify-between mb-5">
                <div>
                    <h2 class="text-base font-extrabold" :class="dark ? 'text-white' : 'text-slate-800'">Ajouter un paiement</h2>
                    <p class="text-[11px] mt-0.5" :class="dark ? 'text-slate-400' : 'text-slate-500'">Remplissez les informations ci-dessous</p>
                </div>
                <Link href="/paiements" class=" text-decoration-none inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold border transition-all"
